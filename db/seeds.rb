...
service_8 = Service.create!(name: "Close to public transport")
service_9 = Service.create!(name: "Fast Internet")
service_10 = Service.create!(name: "Natural light")
service_11 = Service.create!(name: "Safe storage")
service_12 = Service.create!(name: "Lounge room")
...
booking_4 = Booking.create!(beginning_date: Date.new(2019,4,1), end_date: Date.new(2019,4,4), status: "paid",  user: user_2)
booking_5 = Booking.create!(beginning_date: Date.new(2019,3,1), end_date: Date.new(2019,3,2), status: "past",  user: user_3)
