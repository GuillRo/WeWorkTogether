...
place_1 = Place.create!(workspace: workspace_1, price: 23, name: "Shared room", description: "You should rent this room", number_of_chairs: 5)
place_2 = Place.create!(workspace: workspace_1, price: 15, name: "Nice private room", description: "You should rent this room", number_of_chairs: 1)
place_3 = Place.create!(workspace: workspace_1, price: 10, name: "Place for two", description: "You should rent this room", number_of_chairs: 2)
...
place_5 = Place.create!(workspace: workspace_2, price: 22, name: "Shared room", description: "You should rent this room", number_of_chairs: 18)
place_6 = Place.create!(workspace: workspace_2, price: 10, name: "Big desk", description: "You should rent this room", number_of_chairs: 2)
...
place_8 = Place.create!(workspace: workspace_3, price: 17, name: "Shared room", description: "You should rent this room", number_of_chairs: 5)
place_9 = Place.create!(workspace: workspace_4, price: 35, name: "Best desks", description: "You should rent this room", number_of_chairs: 5)
place_10 = Place.create!(workspace: workspace_4, price: 32, name: "Cyber space", description: "You should rent this room", number_of_chairs: 5)
...
place_12 = Place.create!(workspace: workspace_5, price: 18, name: "For hackers only", description: "You should rent this room", number_of_chairs: 5)
...
place_13 = Place.create!(workspace: workspace_5, price: 22, name: "Conference room", description: "You should rent this room", number_of_chairs: 7)
place_15 = Place.create!(workspace: workspace_6, price: 24, name: "Shared office", description: "You should rent this room", number_of_chairs: 9)
place_16 = Place.create!(workspace: workspace_6, price: 25, name: "Good place to work in", description: "You should rent this room", number_of_chairs: 1)
place_17 = Place.create!(workspace: workspace_7, price: 29, name: "Large office", description: "You should rent this room",number_of_chairs: 5)
place_18 = Place.create!(workspace: workspace_7, price: 20, name: "Shared room", description: "You should rent this room",number_of_chairs: 5)
...
place_20 = Place.create!(workspace: workspace_8, price: 30, name: "Meeting room", description: "You should rent this room",number_of_chairs: 5)
place_21 = Place.create!(workspace: workspace_8, price: 19, name: "Large office", description: "You should rent this room",number_of_chairs: 5)
place_22 = Place.create!(workspace: workspace_8, price: 16, name: "Excellent desks", description: "You should rent this room",number_of_chairs: 5)
...
place_24 = Place.create!(workspace: workspace_9, price: 12, name: "Office", description: "You should rent this room",number_of_chairs: 5)
place_25 = Place.create!(workspace: workspace_9, price: 23, name: "Collective desks", description: "You should rent this room",number_of_chairs: 5)
place_26 = Place.create!(workspace: workspace_10, price: 15, name: "Best offices", description: "You should rent this room",number_of_chairs: 5)
place_27 = Place.create!(workspace: workspace_10, price: 19, name: "Shared desks", description: "You should rent this room",number_of_chairs: 5)
place_28 = Place.create!(workspace: workspace_10, price: 18, name: "Coding desks", description: "You should rent this room",number_of_chairs: 5)
place_29 = Place.create!(workspace: workspace_11, price: 16, name: "Shared office", description: "You should rent this room",number_of_chairs: 7)
...
place_31 = Place.create!(workspace: workspace_11, price: 23, name: "Conference room", description: "You should rent this room",number_of_chairs: 52)
place_32 = Place.create!(workspace: workspace_12, price: 20, name: "Meeting room", description: "You should rent this room",number_of_chairs: 5)
place_33 = Place.create!(workspace: workspace_12, price: 14, name: "Private office", description: "You should rent this room",number_of_chairs: 1)
place_35 = Place.create!(workspace: workspace_12, price: 17, name: "Desk", description: "You should rent this room",number_of_chairs: 1)
place_36 = Place.create!(workspace: workspace_13, price: 22, name: "Large room", description: "You should rent this room",number_of_chairs: 1)
place_37 = Place.create!(workspace: workspace_13, price: 28, name: "Collective desks", description: "You should rent this room",number_of_chairs: 1)
place_38 = Place.create!(workspace: workspace_14, price: 30, name: "Private room", description: "You should rent this room",number_of_chairs: 1)
place_40 = Place.create!(workspace: workspace_14, price: 21, name: "Private office", description: "You should rent this room",number_of_chairs: 1)
place_41 = Place.create!(workspace: workspace_14, price: 16, name: "Shared space", description: "You should rent this room",number_of_chairs: 5)
place_42 = Place.create!(workspace: workspace_15, price: 18, name: "Nice place", description: "You should rent this room",number_of_chairs: 5)
place_43 = Place.create!(workspace: workspace_15, price: 20, name: "Big room", description: "You should rent this room",number_of_chairs: 46)
place_44 = Place.create!(workspace: workspace_16, price: 22, name: "Cool desks", description: "You should rent this room",number_of_chairs: 5)
place_45 = Place.create!(workspace: workspace_16, price: 30, name: "Best offices", description: "You should rent this room",number_of_chairs: 5)
place_46 = Place.create!(workspace: workspace_17, price: 19, name: "Cosy workspace", description: "You should rent this room",number_of_chairs: 3)
place_47 = Place.create!(workspace: workspace_17, price: 25, name: "Meeting room", description: "You should rent this room",number_of_chairs: 5)
...
place_49 = Place.create!(workspace: workspace_18, price: 21, name: "Private desk", description: "You should rent this room",number_of_chairs: 1)
place_50 = Place.create!(workspace: workspace_18, price: 29, name: "Collective space", description: "You should rent this room",number_of_chairs: 5)
place_51 = Place.create!(workspace: workspace_18, price: 31, name: "A place for two", description: "You should rent this room",number_of_chairs: 2)
place_52 = Place.create!(workspace: workspace_19, price: 17, name: "Collective offices", description: "You should rent this room",number_of_chairs: 5)
place_53 = Place.create!(workspace: workspace_19, price: 15, name: "Best desks", description: "You should rent this room",number_of_chairs: 5)
...
place_64 = Place.create!(workspace: workspace_23, price: 17, name: "Private desk", description: "You should rent this room",number_of_chairs: 1)
place_65 = Place.create!(workspace: workspace_23, price: 12, name: "Nice space", description: "You should rent this room",number_of_chairs: 5)
place_66 = Place.create!(workspace: workspace_24, price: 29, name: "Private office", description: "You should rent this room",number_of_chairs: 1)
place_67 = Place.create!(workspace: workspace_24, price: 22, name: "Cool desk", description: "You should rent this room",number_of_chairs: 1)
...
place_71 = Place.create!(workspace: workspace_26, price: 28, name: "Coworking desk", description: "You should rent this room",number_of_chairs: 8)
place_72 = Place.create!(workspace: workspace_26, price: 16, name: "Shared space", description: "You should rent this room",number_of_chairs: 46)
