...
booking_1 = Booking.create!(beginning_date: Date.new(2019,2,1), end_date: Date.new(2019,2,3) ,  user: user_1)
booking_2 = Booking.create!(beginning_date: Date.new(2019,5,1), end_date: Date.new(2019,5,8) ,  user: user_1)
booking_3 = Booking.create!(beginning_date: Date.new(2018,12,1), end_date: Date.new(2018,12,3) ,  user: user_1)
booking_4 = Booking.create!(beginning_date: Date.new(2019,4,1), end_date: Date.new(2019,4,4) ,  user: user_2)
booking_5 = Booking.create!(beginning_date: Date.new(2019,3,1), end_date: Date.new(2019,3,2) ,  user: user_3)
booking_6 = Booking.create!(beginning_date: Date.new(2019,2,7), end_date: Date.new(2019,2,10) ,  user: user_3)
booking_7 = Booking.create!(beginning_date: Date.new(2018,2,1), end_date: Date.new(2019,2,5) ,  user: user_4)
booking_8 = Booking.create!(beginning_date: Date.new(2019,2,1), end_date: Date.new(2019,2,28) ,  user: user_4)
booking_9 = Booking.create!(beginning_date: Date.new(2019,4,1), end_date: Date.new(2019,4,10) ,  user: user_4)
booking_10 = Booking.create!(beginning_date: Date.new(2019,3,6), end_date: Date.new(2019,3,6) ,  user: user_5)
booking_11 = Booking.create!(beginning_date: Date.new(2019,2,1), end_date: Date.new(2019,3,3) ,  user: user_6)
booking_12 = Booking.create!(beginning_date: Date.new(2019,9,1), end_date: Date.new(2019,9,17) ,  user: user_7)
booking_13 = Booking.create!(beginning_date: Date.new(2018,11,1), end_date: Date.new(2018,11,10) ,  user: user_7)
booking_14 = Booking.create!(beginning_date: Date.new(2019,2,18), end_date: Date.new(2019,2,20) ,  user: user_7)
booking_15 = Booking.create!(beginning_date: Date.new(2019,2,14), end_date: Date.new(2019,2,19) ,  user: user_8)
booking_16 = Booking.create!(beginning_date: Date.new(2019,5,10), end_date: Date.new(2019,5,12) ,  user: user_8)
booking_17 = Booking.create!(beginning_date: Date.new(2019,2,11), end_date: Date.new(2019,2,15) ,  user: user_9)
booking_18 = Booking.create!(beginning_date: Date.new(2019,4,1), end_date: Date.new(2019,4,3) ,  user: user_9)
booking_19 = Booking.create!(beginning_date: Date.new(2019,1,10), end_date: Date.new(2019,1,15) ,  user: user_9)
booking_20 = Booking.create!(beginning_date: Date.new(2019,1,20), end_date: Date.new(2019,1,23) ,  user: user_9)
booking_21 = Booking.create!(beginning_date: Date.new(2019,6,1), end_date: Date.new(2019,6,3) ,  user: user_10)
booking_22 = Booking.create!(beginning_date: Date.new(2019,7,1), end_date: Date.new(2019,7,10) ,  user: user_11)
booking_23 = Booking.create!(beginning_date: Date.new(2019,3,1), end_date: Date.new(2019,3,3) ,  user: user_12)
booking_24 = Booking.create!(beginning_date: Date.new(2019,4,1), end_date: Date.new(2019,4,5) ,  user: user_12)
booking_25 = Booking.create!(beginning_date: Date.new(2019,4,17), end_date: Date.new(2019,4,20) ,  user: user_12)
booking_26 = Booking.create!(beginning_date: Date.new(2019,9,1), end_date: Date.new(2019,9,20) ,  user: user_13)
booking_27 = Booking.create!(beginning_date: Date.new(2019,8,1), end_date: Date.new(2019,9,1) ,  user: user_13)
booking_28 = Booking.create!(beginning_date: Date.new(2019,7,1), end_date: Date.new(2019,7,2) ,  user: user_14)
booking_29 = Booking.create!(beginning_date: Date.new(2019,10,1), end_date: Date.new(2019,10,29) ,  user: user_14)
booking_30 = Booking.create!(beginning_date: Date.new(2019,5,10), end_date: Date.new(2019,5,14) ,  user: user_14)
