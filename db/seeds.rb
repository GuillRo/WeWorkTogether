...
workspace_1 = Workspace.create!(longitude: 50.84276, latitude: 4.35, user: user_1, description: "The Koekenfabriek is a shared workspace in the heart of Merksem.Freelancers, self-employed and small businesses find a place here to work quietly, meet each other and receive customers in an inspiring environement.", address: "Komiteitstraat 46-52,2170 Merksem", title: "Koekenfabriek", website: "https://www.koekenfabriek.be", phone_number: "0032 474 24 08 30")
workspace_2 = Workspace.create!(longitude: 50, latitude: 50, user: user_2, description: "It is never easy to find the ideal workplace.The office is uninspiring and at home the cat comes undisturbed on your keyboard puffs. What you need is a workplace that gives you energy, focus and a fantastic vibe. A place where you feel at home, but where you can get the best out of yourself professionally.", address: "Grote Hondstraat 44,2018 Antwerpen", title: "House of ape Antwerpen", website: "https://www.apecollective.com/", phone_number: "0032 3 298 77 83")
workspace_3 = Workspace.create!(longitude: 50, latitude: 50, user: user_2, description: "It is never easy to find the ideal workplace.The office is uninspiring and at home the cat comes undisturbed on your keyboard puffs. What you need is a workplace that gives you energy, focus and a fantastic vibe. A place where you feel at home, but where you can get the best out of yourself professionally.", address: "Huidevettersstraat 7,2800 Mechelen", title: "House of ape Mechelen", website: "https://www.apecollective.com/", phone_number: "0032 3 298 77 83")
workspace_4 = Workspace.create!(longitude: 50, latitude: 50, user: user_3, description: "What to do with a beautiful office environment and the desire to facilitate entrepreneurial and creative talent? Right... you offer it the possibility to flourish in a new synergetic setting as part of a brand new coworking initiative. Indian Caps, an old uniform factory in the heart of Antwerp, has been transformed into a creative and flexible work environment with tons of possibilities, facilities and options. You yourself don't have to invest in any office and meeting space, we already made that happen for you! Feel free to explore our website or just pop in to experience this new and exciting coworking adventure! See you soon!", address: "Engelse beurs 4,2000 Antwerpen", title: "Indian caps", website: "http://indiancaps.be", phone_number: "0032 3 222 90 52")
workspace_5 = Workspace.create!(longitude: 50, latitude: 50, user: user_4, description: "Coworking Antwerpen. Need a coworking in Antwerp? Then you must be at StartBloc! We offer the most advantageous and central coworking space in Antwerp! Registered office included!", address: "Meirbrug 1 (7de),2000 Antwerpen", title: "StartBloc Coworking", website: "https://startbloc.nu", phone_number: "0032 495 76 41 76")
workspace_6 = Workspace.create!(longitude: 50, latitude: 50, user: user_5, description: "DOTS offers extremely flexible and favorable membership formulas, in line with what you need. If you do not immediately find something that suits you, contact us or give us a call on 03 369 08 98.", address: "Van Dornestraat 198,2100 Antwerpen", title: "DOTS Coworking", website: "https://www.dots-coworking.be", phone_number: "0032 3 369 08 98")
workspace_7 = Workspace.create!(longitude: 50, latitude: 50, user: user_6, description: "Self-employed coworker : Established or start-up, in main or secondary occupation? Plug into an inspiring group of risk-takers and doers in pleasant, professional sites. Working, networking and sharing knowledge. Corporate coworker : Avoid expensive file-hours? Looking for a better worklifebalans? For employees and employers, our coworkinglocaties offer a sustainable mobility solution.Coworking manager : Do you have a coworking space yourself? Or are you dreaming of connecting entrepreneurs? .Cooperation pays. Take a quick look at what we can do for you.", address: "Lange Winkelhaakstraat 26,2060 Antwerpen", title: "Bar d'Office de Winkelhaak", website: "https://bardoffice.eu/", phone_number: "0032 3 303 90 73")
workspace_8 = Workspace.create!(longitude: 50, latitude: 50, user: user_6, description: "Self-employed coworker : Established or start-up, in main or secondary occupation? Plug into an inspiring group of risk-takers and doers in pleasant, professional sites. Working, networking and sharing knowledge. Corporate coworker : Avoid expensive file-hours? Looking for a better worklifebalans? For employees and employers, our coworkinglocaties offer a sustainable mobility solution.Coworking manager : Do you have a coworking space yourself? Or are you dreaming of connecting entrepreneurs? .Cooperation pays. Take a quick look at what we can do for you.", address: "Zwaantjesstraat 33,9090 Melle", title: "Bar d'Office Idee Kids", website: "https://bardoffice.eu/", phone_number: "0032 3 303 90 73")
workspace_9 = Workspace.create!(longitude: 50, latitude: 50, user: user_6, description: "Self-employed coworker : Established or start-up, in main or secondary occupation? Plug into an inspiring group of risk-takers and doers in pleasant, professional sites. Working, networking and sharing knowledge. Corporate coworker : Avoid expensive file-hours? Looking for a better worklifebalans? For employees and employers, our coworkinglocaties offer a sustainable mobility solution.Coworking manager : Do you have a coworking space yourself? Or are you dreaming of connecting entrepreneurs? .Cooperation pays. Take a quick look at what we can do for you.", address: "Ulbeekstraat 21,3830 Wellen", title: "Bar d'Office Ulbeek", website: "https://bardoffice.eu/", phone_number: "0032 3 303 90 73")
workspace_10 = Workspace.create!(longitude: 50, latitude: 50, user: user_6, description: "Self-employed coworker : Established or start-up, in main or secondary occupation? Plug into an inspiring group of risk-takers and doers in pleasant, professional sites. Working, networking and sharing knowledge. Corporate coworker : Avoid expensive file-hours? Looking for a better worklifebalans? For employees and employers, our coworkinglocaties offer a sustainable mobility solution.Coworking manager : Do you have a coworking space yourself? Or are you dreaming of connecting entrepreneurs? .Cooperation pays. Take a quick look at what we can do for you.", address: "Vestinglaan 55,2650 Edegem", title: "Bar d'Office BLWRK", website: "https://bardoffice.eu/", phone_number: "0032 3 303 90 73")
workspace_11 = Workspace.create!(longitude: 50, latitude: 50, user: user_6, description: "Self-employed coworker : Established or start-up, in main or secondary occupation? Plug into an inspiring group of risk-takers and doers in pleasant, professional sites. Working, networking and sharing knowledge. Corporate coworker : Avoid expensive file-hours? Looking for a better worklifebalans? For employees and employers, our coworkinglocaties offer a sustainable mobility solution.Coworking manager : Do you have a coworking space yourself? Or are you dreaming of connecting entrepreneurs? .Cooperation pays. Take a quick look at what we can do for you.", address: "Kanunnik de Deckerstraat 20a,Mechelen", title: "Bar d'Office Oh!", website: "https://bardoffice.eu/", phone_number: "0032 3 303 90 73")
workspace_12 = Workspace.create!(longitude: 50, latitude: 50, user: user_6, description: "Self-employed coworker : Established or start-up, in main or secondary occupation? Plug into an inspiring group of risk-takers and doers in pleasant, professional sites. Working, networking and sharing knowledge. Corporate coworker : Avoid expensive file-hours? Looking for a better worklifebalans? For employees and employers, our coworkinglocaties offer a sustainable mobility solution.Coworking manager : Do you have a coworking space yourself? Or are you dreaming of connecting entrepreneurs? .Cooperation pays. Take a quick look at what we can do for you.", address: "Hopmarkt 50,9300 Aalst", title: "Bar d'Office Hopmarkt 50", website: "https://bardoffice.eu/", phone_number: "0032 3 303 90 73")
workspace_13 = Workspace.create!(longitude: 50, latitude: 50, user: user_6, description: "Self-employed coworker : Established or start-up, in main or secondary occupation? Plug into an inspiring group of risk-takers and doers in pleasant, professional sites. Working, networking and sharing knowledge. Corporate coworker : Avoid expensive file-hours? Looking for a better worklifebalans? For employees and employers, our coworkinglocaties offer a sustainable mobility solution.Coworking manager : Do you have a coworking space yourself? Or are you dreaming of connecting entrepreneurs? .Cooperation pays. Take a quick look at what we can do for you.", address: "Grensstraat 3,2200 Herentals", title: "Bar d'Office Campus Aquafin ", website: "https://bardoffice.eu/", phone_number: "0032 3 303 90 73")
workspace_14 = Workspace.create!(longitude: 50, latitude: 50, user: user_6, description: "Self-employed coworker : Established or start-up, in main or secondary occupation? Plug into an inspiring group of risk-takers and doers in pleasant, professional sites. Working, networking and sharing knowledge. Corporate coworker : Avoid expensive file-hours? Looking for a better worklifebalans? For employees and employers, our coworkinglocaties offer a sustainable mobility solution.Coworking manager : Do you have a coworking space yourself? Or are you dreaming of connecting entrepreneurs? .Cooperation pays. Take a quick look at what we can do for you.", address: "Gouverneur Verwilghensingel 30a,3500 Hasselt", title: "Bar d'Office Co-Workspace", website: "https://bardoffice.eu/", phone_number: "0032 3 303 90 73")
workspace_15 = Workspace.create!(longitude: 50, latitude: 50, user: user_6, description: "Self-employed coworker : Established or start-up, in main or secondary occupation? Plug into an inspiring group of risk-takers and doers in pleasant, professional sites. Working, networking and sharing knowledge. Corporate coworker : Avoid expensive file-hours? Looking for a better worklifebalans? For employees and employers, our coworkinglocaties offer a sustainable mobility solution.Coworking manager : Do you have a coworking space yourself? Or are you dreaming of connecting entrepreneurs? .Cooperation pays. Take a quick look at what we can do for you.", address: "Dorpstraat 29,2920 Kalmthout", title: "Bar d'OfficeFlex OFie's", website: "https://bardoffice.eu/", phone_number: "0032 3 303 90 73")
workspace_16 = Workspace.create!(longitude: 50, latitude: 50, user: user_6, description: "Self-employed coworker : Established or start-up, in main or secondary occupation? Plug into an inspiring group of risk-takers and doers in pleasant, professional sites. Working, networking and sharing knowledge. Corporate coworker : Avoid expensive file-hours? Looking for a better worklifebalans? For employees and employers, our coworkinglocaties offer a sustainable mobility solution.Coworking manager : Do you have a coworking space yourself? Or are you dreaming of connecting entrepreneurs? .Cooperation pays. Take a quick look at what we can do for you.", address: "Dijstraat 8 Aartselaar", title: "Bar d'Office Campus Aquafin", website: "https://bardoffice.eu/", phone_number: "0032 3 303 90 73")
workspace_17 = Workspace.create!(longitude: 50, latitude: 50, user: user_6, description: "Self-employed coworker : Established or start-up, in main or secondary occupation? Plug into an inspiring group of risk-takers and doers in pleasant, professional sites. Working, networking and sharing knowledge. Corporate coworker : Avoid expensive file-hours? Looking for a better worklifebalans? For employees and employers, our coworkinglocaties offer a sustainable mobility solution.Coworking manager : Do you have a coworking space yourself? Or are you dreaming of connecting entrepreneurs? .Cooperation pays. Take a quick look at what we can do for you.", address: "Diestsevest 76,3000 Leuven", title: "Bar d'Office Flanders DC", website: "https://bardoffice.eu/", phone_number: "0032 3 303 90 73")
workspace_18 = Workspace.create!(longitude: 50, latitude: 50, user: user_6, description: "Self-employed coworker : Established or start-up, in main or secondary occupation? Plug into an inspiring group of risk-takers and doers in pleasant, professional sites. Working, networking and sharing knowledge. Corporate coworker : Avoid expensive file-hours? Looking for a better worklifebalans? For employees and employers, our coworkinglocaties offer a sustainable mobility solution.Coworking manager : Do you have a coworking space yourself? Or are you dreaming of connecting entrepreneurs? .Cooperation pays. Take a quick look at what we can do for you.", address: "Campus Blairon 714,2300 Turnhout", title: "Bar d'Office Blenders ", website: "https://bardoffice.eu/", phone_number: "0032 3 303 90 73")
workspace_19 = Workspace.create!(longitude: 50, latitude: 50, user: user_7, description: "FEEL AT HOME. We strongly believe in the fact that an office should feel as comfortable as your own home. Read the morning news in our coffee lounge, scroll through your mails in our lush garden or start working at your very own desk. At Friday, every day feels like a Friday. Welcome home.", address: "Lange Leemstraat 358B,2018 Antwerp", title: "Friday Cowork", website: "https://www.friday-cowork.be", phone_number: "0032 472 84 14 11")
workspace_20 = Workspace.create!(longitude: 50, latitude: 50, user: user_8, description: "We are a coworking space. We also have event spaces and meeting rooms. But we also have a little extra that makes all the difference. Meet Hive5, the coworking and event beehive!", address: "Cours Saint-Michel 30 - Securex building 2nd floor, 1040 Brussels", title: "Hive5", website: "https://www.hive5.be", phone_number: "0491 63 93 50")
workspace_21 = Workspace.create!(longitude: 50, latitude: 50, user: user_9, description: "We want to help starters, self-employed and small businesses in their development and growth, by creating connections and inspiring them, in a cosy and professional atmosphere.", address: "500 Avenue Louise, 1050 Bruxelles", title: "Manistal", website: "https://manistal.be", phone_number: "02 207 94 80")
workspace_22 = Workspace.create!(longitude: 50, latitude: 50, user: user_10, description: "The most innovative provider of shared flexible workspaces", address: "Avenue des Arts 56, 1000 Brussels", title: "Workero", website: "https://www.workero.com", phone_number: "02 431 08 08")
workspace_23 = Workspace.create!(longitude: 50, latitude: 50, user: user_11, description: "The co-working areas are airy and well-equipped with just the right balance of calm and bustle whilst the meeting rooms have different shaping that will put your guests at ease and make them feel like home.", address: "Rue de l’Aurore 4,1000 Brussels", title: "The Library Ixelles", website: "https://thelibrarygroup.be", phone_number: "02 342 07 43")
workspace_24 = Workspace.create!(longitude: 50, latitude: 50, user: user_11, description: "The co-working areas are airy and well-equipped with just the right balance of calm and bustle whilst the meeting rooms have different shaping that will put your guests at ease and make them feel like home.", address: "Ave. Broqueville 40, 1200 W.S.L", title: "The Library Europe", website: "https://thelibrarygroup.be", phone_number: "02 342 07 43")
workspace_25 = Workspace.create!(longitude: 50, latitude: 50, user: user_11, description: "The co-working areas are airy and well-equipped with just the right balance of calm and bustle whilst the meeting rooms have different shaping that will put your guests at ease and make them feel like home.", address: "Square Ambiorix 10, 1000 Brussels", title: "The Library Ambiorix", website: "https://thelibrarygroup.be", phone_number: "02 342 07 43")
workspace_26 = Workspace.create!(longitude: 50, latitude: 50, user: user_12, description: "Welcome to Factory Forty, the coworking space that allows you to work in the sunshine, right in the heart of Brussels*.", address: "rue des anciens étangs, 40 , 1190 Brussels", title: "Factory Forty", website: "https://www.factoryforty.be", phone_number: "02.430.24.22")
workspace_27 = Workspace.create!(longitude: 50, latitude: 50, user: user_13, description: "Coworking les Galeries makes you instantly feel at home. Based in a historical setting in Brussels King’s Gallery dating back from 1847 and 50 steps away from the famous Grand-Place, this boutique coworking space is designed for conscious professionals looking for a place to meet, work, and chill.", address: "Galerie du Roi, 30 - 1000 Bruxelles", title: "Les Galeries", website: "http://www.galeriescoworking.be", phone_number: "0484 78 17 83")
...
place_2 = Place.create!(workspace: workspace_1, price: 15)
place_3 = Place.create!(workspace: workspace_1, price: 10)
place_4 = Place.create!(workspace: workspace_2, price: 20)
place_5 = Place.create!(workspace: workspace_2, price: 22)
place_6 = Place.create!(workspace: workspace_2, price: 10)
place_7 = Place.create!(workspace: workspace_3, price: 15)
place_8 = Place.create!(workspace: workspace_3, price: 17)
place_9 = Place.create!(workspace: workspace_4, price: 35)
place_10 = Place.create!(workspace: workspace_4, price: 32)
place_11 = Place.create!(workspace: workspace_5, price: 31)
place_12 = Place.create!(workspace: workspace_5, price: 18)
place_13 = Place.create!(workspace: workspace_5, price: 22)
place_14 = Place.create!(workspace: workspace_6, price: 23)
place_15 = Place.create!(workspace: workspace_6, price: 24)
place_16 = Place.create!(workspace: workspace_6, price: 25)
place_17 = Place.create!(workspace: workspace_7, price: 29)
place_18 = Place.create!(workspace: workspace_7, price: 20)
place_19 = Place.create!(workspace: workspace_7, price: 25)
place_20 = Place.create!(workspace: workspace_8, price: 30)
place_21 = Place.create!(workspace: workspace_8, price: 19)
place_22 = Place.create!(workspace: workspace_8, price: 16)
place_23 = Place.create!(workspace: workspace_9, price: 18)
place_24 = Place.create!(workspace: workspace_9, price: 12)
place_25 = Place.create!(workspace: workspace_9, price: 23)
place_26 = Place.create!(workspace: workspace_10, price: 15)
place_27 = Place.create!(workspace: workspace_10, price: 19)
place_28 = Place.create!(workspace: workspace_10, price: 18)
place_29 = Place.create!(workspace: workspace_11, price: 16)
place_30 = Place.create!(workspace: workspace_11, price: 17)
place_31 = Place.create!(workspace: workspace_11, price: 23)
place_32 = Place.create!(workspace: workspace_12, price: 20)
place_33 = Place.create!(workspace: workspace_12, price: 14)
place_35 = Place.create!(workspace: workspace_12, price: 17)
place_36 = Place.create!(workspace: workspace_13, price: 22)
place_37 = Place.create!(workspace: workspace_13, price: 28)
place_38 = Place.create!(workspace: workspace_14, price: 30)
place_40 = Place.create!(workspace: workspace_14, price: 21)
place_41 = Place.create!(workspace: workspace_14, price: 16)
place_42 = Place.create!(workspace: workspace_15, price: 18)
place_43 = Place.create!(workspace: workspace_15, price: 20)
place_44 = Place.create!(workspace: workspace_16, price: 22)
place_45 = Place.create!(workspace: workspace_16, price: 30)
place_46 = Place.create!(workspace: workspace_17, price: 19)
place_47 = Place.create!(workspace: workspace_17, price: 25)
place_48 = Place.create!(workspace: workspace_17, price: 14)
place_49 = Place.create!(workspace: workspace_18, price: 21)
place_50 = Place.create!(workspace: workspace_18, price: 29)
place_51 = Place.create!(workspace: workspace_18, price: 31)
place_52 = Place.create!(workspace: workspace_19, price: 17)
place_53 = Place.create!(workspace: workspace_19, price: 15)
place_54 = Place.create!(workspace: workspace_19, price: 20)
place_55 = Place.create!(workspace: workspace_20, price: 25)
place_56 = Place.create!(workspace: workspace_20, price: 30)
place_57 = Place.create!(workspace: workspace_20, price: 18)
place_58 = Place.create!(workspace: workspace_21, price: 23)
place_59 = Place.create!(workspace: workspace_21, price: 14)
place_60 = Place.create!(workspace: workspace_22, price: 30)
place_61 = Place.create!(workspace: workspace_22, price: 25)
place_62 = Place.create!(workspace: workspace_22, price: 13)
place_63 = Place.create!(workspace: workspace_23, price: 20)
place_64 = Place.create!(workspace: workspace_23, price: 17)
place_65 = Place.create!(workspace: workspace_23, price: 12)
place_66 = Place.create!(workspace: workspace_24, price: 29)
place_67 = Place.create!(workspace: workspace_24, price: 22)
place_68 = Place.create!(workspace: workspace_25, price: 30)
place_69 = Place.create!(workspace: workspace_25, price: 25)
place_70 = Place.create!(workspace: workspace_25, price: 18)
place_71 = Place.create!(workspace: workspace_26, price: 28)
place_72 = Place.create!(workspace: workspace_26, price: 16)
place_73 = Place.create!(workspace: workspace_27, price: 22)
place_74 = Place.create!(workspace: workspace_27, price: 30)
place_75 = Place.create!(workspace: workspace_27, price: 15)
...
BookingPlace.create!(booking: booking_2, place: place_12)
...
BookingPlace.create!(booking: booking_5, place: place_64)
...
BookingPlace.create!(booking: booking_15, place: place_69)
BookingPlace.create!(booking: booking_16, place: place_10)
BookingPlace.create!(booking: booking_17, place: place_73)
BookingPlace.create!(booking: booking_17, place: place_74)
...
BookingPlace.create!(booking: booking_24, place: place_53)
...
BookingPlace.create!(booking: booking_26, place: place_41)
BookingPlace.create!(booking: booking_27, place: place_30)
BookingPlace.create!(booking: booking_27, place: place_31)
BookingPlace.create!(booking: booking_28, place: place_55)
BookingPlace.create!(booking: booking_28, place: place_56)
